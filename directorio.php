...
<body>
    <nav class="navbar navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="index.php"><img style="width: 35px; filter:invert(1)" src="./assets/img/left-arrow.png" alt=""> Inicio</a>
        </div>
    </nav>
    <br>
    <div class="container">
        ...
        <hr>
        <p>
            <button class="btn btn-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample" style= "background-color:white; color:black">
                Crear archivo nuevo
            </button>
        </p>
        <div class="collapse" id="collapseExample">
            <form action="directorio.php?dir=<?php echo $dir ?>" method="post">
                <textarea placeholder="Escribe algo..." name="contentn" style="height: 500px;" class="form-control bg-light" id="" cols="30" rows="10"></textarea>
                <br>
        ...
        <div class="row row-cols-4 w-75 mx-auto">
            <table class="table table-borderless caption-top table-light table-striped table-hover">
                <caption style="color: rgb(23, 24, 24);">Archivos</caption>
                <thead>
                    <tr>
