...
<body>
        ...
        <div class="collapse" id="collapseExample">
            <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="post">
                <div class="input-group mb-3">
                    ...
                    <button style= "background-color:white; color:black" type="submit" name="create" class="btn btn-outline-secondary" type="button" id="button-addon2" >Crear</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="row row-cols-4 w-75 mx-auto">
        ...
        <table class="table table-borderless caption-top table-light table-striped table-hover">
            <caption style="color: purple;">Carpetas</caption>
            <thead>
                <tr>
